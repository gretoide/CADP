...
procedure salarioT (salario:integer; var salarioTOTAL:longint); {Devuelve salario total para calcular el salario promedio}{PROBAR CON LONGINT}
begin
...
var
	dato : Tdatos;
	fin : boolean;
	cantEmpleados, min1, min2, max, legajo,salarioCANT,opciones,empleadoEspecial,doble,cant0,anterior,cantPoI: integer;
	dniMin1, dniMin2: string;
	salarioTOTAL:longint;
	car,menuL:char;
begin
	cantEmpleados:=0;
    salarioCANT:= 0;
